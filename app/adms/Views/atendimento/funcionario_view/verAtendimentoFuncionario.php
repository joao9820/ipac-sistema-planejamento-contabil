                ...
                <div class="p-2 d-flex flex-md-row flex-column  align-items-center">
                    ...
                    <span class="d-none d-md-block">
                        ...
                        if ($this->Dados['botao']['list_atendimento']) {
                            echo "<a href='" . URLADM . "atendimentos/listar/$pg' class='btn btn-outline-info btn-sm'>Listar Atendimentos</a> ";
                        }
                    ...
                    <div class="dropdown d-block d-md-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                            <?php
                            if ($this->Dados['botao']['list_atendimento']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "atendimentos/listar/$pg'>Listar Atendimentos</a>";
                            }

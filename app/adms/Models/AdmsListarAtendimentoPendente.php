...
class AdmsListarAtendimentoPendente
{
    ...
    public function listarAtendimento($PageId = null)
    {
        ...
        $paginacao->paginacao("SELECT COUNT(id) AS num_result
                     ...
                     WHERE adms_funcionario_id =:usuario", "usuario=".$_SESSION['usuario_id']);
        ...
        $listarAtendimento->fullRead("SELECT aten.id, aten.descricao, aten.created, 
                        ...
                        ORDER BY created DESC LIMIT :limit OFFSET :offset", "usuario=".$_SESSION['usuario_id']."&adms_sits_atendimento_id=4&limit={$this->LimiteResultado}&offset={$offset}");

...
$(document).ready(function () {
    ...
    $('a[data-sitAtenIniciar]').click(function (ev) {
        ...
        if (!$('#confirmIniciar').length) {
            $('body').append('<div class="modal fade" id="confirmIniciar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header bg-secondary text-white">Iniciar atividade<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"><h3 class="text-secondary text-center">Tem certeza que deseja iniciar está atividade agora?</h3></div><div class="modal-footer"><button type="button" class="btn btn-outline-secondary" data-dismiss="modal"><i class="fas fa-ban"></i> Cancelar</button><a class="btn btn-outline-success" id="dataComfirmOKiniciar"><i class="fas fa-hourglass-start"></i> Iniciar</a></div></div></div></div>');
        }
    ...
    $('a[data-sitAtenPausar]').click(function (ev) {
        ...
        if (!$('#confirmPausar').length) {
            $('body').append('<div class="modal fade" id="confirmPausar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header bg-warning text-white">Pausar atividade<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"><div><h3 class="text-secondary text-center">Tem certeza que deseja pausar está atividade?</h3></div></div><div class="modal-footer"><button type="button" class="btn btn-outline-secondary" data-dismiss="modal"><i class="fas fa-ban"></i> Cancelar</button><a class="btn btn-outline-warning" id="dataComfirmOKpausar"><i class="fas fa-pause"></i> Pausar</a></div></div></div></div>');
        }

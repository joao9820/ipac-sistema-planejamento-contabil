...
class BuscarDuracaoAtividadesAlocacao
{
    ...
    private function buscar()
    {
        ...
        if (isset($this->Status)){
            $query->fullRead("SELECT SEC_TO_TIME(SUM(TIME_TO_SEC(alocacao_atividade)))  AS duracao_atividade, SUM(TIME_TO_SEC(alocacao_atividade))  AS duracao_atividade_sc

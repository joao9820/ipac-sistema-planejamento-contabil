        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="descricao" class="form-control" rows="3" id="editor-um"><?php
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="conteudo" class="form-control" rows="3" id="editor-dois"><?php
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="resumo_publico" class="form-control" rows="3" id="editor-tres"><?php

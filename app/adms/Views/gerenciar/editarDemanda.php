...
<div class="content p-1">
    <div class="list-group-item">
        <div class="d-flex">
            ...
            <div class="p-2">
                <span class="d-block">
                    <a href="<?php echo URLADM . 'ver-demanda/ver-demanda/'.$valorForm['id']; ?>" class="btn btn-outline-primary btn-sm"><i class="far fa-eye"></i> Visualizar</a>
                </span>
            </div>
                <?php
            }
        ...
        <form method="post" action="" class="col-md-6">
            ...
            <input type="submit" name="EditDemanda" value="Salvar" class="btn btn-outline-success">
        </form>
    </div>
</div>

...
class AdmsAtendimentoFuncionarios {
    ...
    public function listar($Atendimento = null) {
        ...
        $listar = new AdmsRead();
        $listar->fullRead("SELECT aten_fun.id id_aten_fun,aten_fun.duracao_atividade, aten_fun.data_fatal, aten_fun.ordem_atividade, aten_fun.adms_sits_atendimentos_funcionario_id sit_func, aten_fun.prioridade,
